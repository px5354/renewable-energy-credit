<template>
  <div class="container">
    <!-- <md-table v-model="this.orderData" md-card md-fixed-header @selected="onSelect"> -->
    <md-table v-model="this.orderBookData" md-card md-fixed-header>
...
export default {
  name: "formcard",
  props: ['title', 'energyType', 'orderBookData'],
  props: {
    title: String,
    energyType: Object,
    orderBookData: Array,
